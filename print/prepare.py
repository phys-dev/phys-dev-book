...
VOLUMES = {
    None: {
        ...
        "abstract": (
            ...
            "эксперимента. Изложение идёт от основания к применению: помощники "
            "на языковых моделях и контроль версий, GNU/Linux и контейнеры, "
            "устройство языка Python, алгоритмы и структуры данных, инженерные "
            "практики от требований к коду до баз данных, обработка и "
            "визуализация данных, машинное обучение, ускорение расчётов вплоть "
            "до графических ускорителей. Завершают книгу разбор программ, "
            "которыми считают физику в институтах СО РАН, и задания для "
            "самостоятельной работы. От общего курса программирования пособие "
            "отличается подбором материала: задачи взяты из физического "
            "эксперимента, а вместо учебных примеров разобраны работающие коды "
            "установок."),
    },
}
