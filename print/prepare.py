...
VOLUMES = {
    None: {
        ...
        "abstract": (
            "Пособие проводит через весь путь: помощники на языковых моделях "
            "и контроль версий, GNU/Linux и контейнеры, устройство языка Python, "
            "алгоритмы и структуры данных, инженерные практики от требований "
            "к коду до баз данных, обработку и визуализацию данных, машинное "
            "обучение, ускорение расчётов вплоть до графических ускорителей. "
            "Завершают книгу разбор программ, которыми считают физику "
            "в институтах СО РАН, и задания для самостоятельной работы. "
            "От общих курсов программирования пособие отличается тем, что "
            "материал подобран под задачи физического эксперимента, а "
            "разбираются работающие коды установок, а не учебные примеры."),
    },
}
