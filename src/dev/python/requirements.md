...
> Большинство перечисленных пунктов проверяют автоматически линтеры и форматтеры `ruff`, `flake8`, `black`, `isort`, работающие прямо в редакторе. Настрой их в редакторе и в CI, и следить за этими правилами вручную почти не придётся.
